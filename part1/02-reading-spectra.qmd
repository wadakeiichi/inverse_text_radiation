...
![プランク曲線の読み取り方。三つの温度（$T$, $1.5T$, $2T$）の $B_\nu$ を重ねた。温度が上がると、**ピーク位置は高振動数側へ移り**（$\nu_\text{peak}\propto T$、Wien の変位則 @eq-wien-displacement）、**曲線下の面積は $T^4$ で増える**（Stefan–Boltzmann 則、§2.4）。さらに低振動数側は $\propto\nu^2$ で立ち上がり（Rayleigh–Jeans、§2.5）、高振動数側は指数関数的に落ちる（Wien 近似）。一枚の曲線から温度・全放射・両極限が読み取れる。](../images/planck-reading.svg){#fig-planck-reading width=88%}
...
[解答例を見る（問題 2-1）](#sol-2-1){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 2-2）](#sol-2-2){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 2-3）](#sol-2-3){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 2-4）](#sol-2-4){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 2-5）](#sol-2-5){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::

## 解答例 {#sec-reading-spectra-solutions .unnumbered}

各問の「解答例を見る」ボタンを押すと、右側のパネルに解答例が表示され、問題文と見比べられる（背景は暗くならず本文はそのまま読める）。印刷版・EPUB版では下に順に掲載される。

::: {.content-visible when-format="html"}
[問題 2-1](#sol-2-1){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 2-2](#sol-2-2){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 2-3](#sol-2-3){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 2-4](#sol-2-4){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 2-5](#sol-2-5){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::

::: {#sol-2-1 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-2-1-label"}
::: {.offcanvas-header}
[**解答例（問題 2-1）**]{#sol-2-1-label .offcanvas-title}
...
::: {#sol-2-2 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-2-2-label"}
::: {.offcanvas-header}
[**解答例（問題 2-2）**]{#sol-2-2-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}
...
::: {#sol-2-3 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-2-3-label"}
::: {.offcanvas-header}
[**解答例（問題 2-3）**]{#sol-2-3-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}
**(1)** 黒体は等方なので $B_\nu$ は方向に依らず積分の外へ：
...
::: {#sol-2-4 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-2-4-label"}
::: {.offcanvas-header}
[**解答例（問題 2-4）**]{#sol-2-4-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}
...
::: {#sol-2-5 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-2-5-label"}
::: {.offcanvas-header}
[**解答例（問題 2-5）**]{#sol-2-5-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}

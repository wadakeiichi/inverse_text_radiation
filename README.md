...
本書はドラフト第 v0.1 段階で、宇宙物理・分光学・原子物理・量子論・統計力学・QED 等の専門家から **批判的レビュー** を受け付けています。

### 見ていただきたいこと

- **物理的正しさ**：式・数値・近似の妥当性
- **逆引き構成の評価**：観測 → 物理の流れが学生に届くか
- **教育的有効性**：B2〜M1 の標準的学生にとって難易度・例題・節内問いが適切か
- **観測実例の妥当性**：CMB, 恒星 SED, 円盤, AGN, 21 cm 等
- **文献の網羅性**：邦書・洋書の漏れ、最新文献の追加
- **章間整合性**：参照・記号・用語の統一
...
3. **コメントを返す**：以下のいずれか
   ...
   - メール（<wada@astrophysics.jp>）で自由形式

ご協力は本書のあとがき・謝辞に明記します。締切や粒度の指定はカバーレター（`REVIEW.md`）参照。

...
詳細は**第14章で導出**する（ここでは仮に借りる）。**本章では結果だけを借用し**、第14章でこの借用を返す（@sec-classical-failure-modes ↔ [第14章 空洞モード](../part5/14-cavity-modes.qmd)の往復で確認できる）。**振動数 $\nu$ あたりの単位体積あたりのモード数**は
...
::: {.callout-note}
**方針（仮に借りる）**：@eq-mode-density-borrowed の導出には**量子論は一切要らない**。古典電磁気と境界条件だけで出る幾何的な数え上げである。本格的な導出は**第14章で行う**ので、本章では「古典電磁気が許す結果」として一度受け入れ（仮に借り）、第14章で借用を返す。中心地図の各因子について「初出／仮に借りる場所／本当に導出する場所」は第14章で一覧化される。
:::
...
### 問題 9-1　空洞モード密度 g(ν)=8πν²/c³ の数え上げ {#ex-9-1 .unnumbered}
...
[解答例を見る（問題 9-1）](#sol-9-1){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::

### 問題 9-2　古典分配関数から 1モードの平均エネルギー kBT {#ex-9-2 .unnumbered}
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 9-2）](#sol-9-2){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
§9.3 は $u_\mathrm{classical}=\int_0^\infty u_\nu^\mathrm{RJ}d\nu=\infty$ を示した。なぜ「紫外線」破綻と呼ぶのかを定量的に確かめる。
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 9-3）](#sol-9-3){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::
...
::: {.content-visible when-format="html"}
[解答例を見る（問題 9-4）](#sol-9-4){.btn .btn-outline-secondary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::

## 解答例 {#sec-classical-failure-solutions .unnumbered}

各問の「解答例を見る」ボタンを押すと、右側のパネルに解答例が表示され、問題文と見比べられる（背景は暗くならず本文はそのまま読める）。印刷版・EPUB版では下に順に掲載される。

::: {.content-visible when-format="html"}
[問題 9-1](#sol-9-1){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 9-2](#sol-9-2){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 9-3](#sol-9-3){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"} [問題 9-4](#sol-9-4){.btn .btn-outline-primary .btn-sm data-bs-toggle="offcanvas" role="button"}
:::

::: {#sol-9-1 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-9-1-label"}
::: {.offcanvas-header}
[**解答例（問題 9-1）**]{#sol-9-1-label .offcanvas-title}
...
::: {#sol-9-2 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-9-2-label"}
::: {.offcanvas-header}
[**解答例（問題 9-2）**]{#sol-9-2-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}
**(1)** 位置と運動量の積分が分離する：
...
::: {#sol-9-3 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-9-3-label"}
::: {.offcanvas-header}
[**解答例（問題 9-3）**]{#sol-9-3-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}
...
::: {#sol-9-4 .offcanvas .offcanvas-end tabindex="-1" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="sol-9-4-label"}
::: {.offcanvas-header}
[**解答例（問題 9-4）**]{#sol-9-4-label .offcanvas-title}
[ ]{.btn-close data-bs-dismiss="offcanvas" aria-label="閉じる"}
:::
::: {.offcanvas-body}

...
### 問題 22-1　Doppler 幅 ― 熱運動の Gaussian {#ex-22-1 .unnumbered}
...
**関連**：[§22.2 Doppler 拡がり](#sec-line-shape-doppler)／Maxwell 分布は[第III部 演習](../part3/07-statistical-mechanics.qmd)、マクロ速度場は[§22.5](#sec-line-shape-macro)（[演習 22-4](#ex-22-4)）。
...
### 問題 22-2　自然幅 ― 寿命から Lorentzian {#ex-22-2 .unnumbered}

[★ 難易度：☆☆ ] [tag:導出補完]

§22.1 の自然幅。励起寿命 $\tau_u=1/A_{ul}$、振動数単位の自然幅 $\gamma_\mathrm{nat}=A_{ul}/(2\pi)$。Ly$\alpha$（$\lambda=121.6$ nm、$A_{ul}=6.27\times10^8$ s$^{-1}$）について。
...
**関連**：[§22.1 自然幅](#sec-line-shape-natural)／$A_{ul}$ と自然幅は[演習 11-4](../part4/11-einstein-method.qmd#ex-11-4)、真空揺らぎとの関係は[§25.4](../part8/25-qed-minimum.qmd#sec-qed-minimum-natural-width)（[第VIII部 演習](../part8/25-qed-minimum.qmd)）。
...
### 問題 22-3　Voigt プロファイル ― コアと翼を別プローブに {#ex-22-3 .unnumbered}
...
**関連**：[§22.4 Voigt プロファイル](#sec-line-shape-voigt)、[§22.3 衝突拡がり](#sec-line-shape-pressure)／恒星の $\log g$ 決定は[§22.3](#sec-line-shape-pressure)、curve of growth の減衰翼は[演習 20-3](../part7/20-line-formation.qmd#ex-20-3)。
...
### 問題 22-4　熱的幅と乱流の分離、Zeeman で磁場 {#ex-22-4 .unnumbered}
...
**関連**：[§22.5 マクロな速度場](#sec-line-shape-macro)、[§22.6 Zeeman 効果](#sec-line-shape-zeeman)／偏光は[演習 13-4](../part5/13-electromagnetic-waves.qmd#ex-13-4)。
